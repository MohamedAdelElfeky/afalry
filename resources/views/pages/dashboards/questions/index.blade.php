<x-default-layout>
    ...
    <div class="card mb-5 mb-xl-8">
        <div class="card-header border-0 pt-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold fs-3 mb-1">{{ __('lang.questions') }}</span>
            </h3>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-end flexpca-shrink-0">
                                        ...
                                        @include('pages/dashboards/questions/edit')
                ...
                <div class="pagination justify-content-center">
                    <nav role="navigation" aria-label="Pagination Navigation">
                        <div class="flex items-center justify-between">
                            ...
                            @foreach ($questions->getUrlRange(max(1, $questions->currentPage() - 1), min($questions->lastPage(), $questions->currentPage() + 1)) as $page => $url)
                                <a href="{{ $url }}"
                                    class="btn btn-outline-secondary {{ $page == $questions->currentPage() ? 'active' : '' }}">{{ $page }}</a>
                            @endforeach
    ...
    @include('pages/dashboards/questions/add')
